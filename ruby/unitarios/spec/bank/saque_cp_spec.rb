...
describe ContaPoupanca do
    ...
    describe 'Saque' do
        context 'quando o valor é positivo' do
            ...
            context 'quando o valor é zero' do
                before(:all) do
                    ...
                    it 'entao exibe a mensagem' do
                        expect(@cp.mensagem).to eql 'Saldo insulficiente para saque :('
                    end
            ...
            context 'quando o valor é insulficiente' do
                before(:all) do
            ...
            context 'quando supera o limite de saque' do
                before(:all) do
                    ...
                    it 'entao exibe a mensagem' do
                    expect(@cp.mensagem).to eql 'Limite maximo para saque de R$500'
                end
